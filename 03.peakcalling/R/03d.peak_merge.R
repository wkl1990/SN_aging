...
parser$add_argument("--blacklist", default = "mm10.blacklist.bed.gz", help="blacklist in bed gz")
parser$add_argument("--chromSize", default = "mm10.chrom.sizes", help="chrom size")
